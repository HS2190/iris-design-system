...
import { TextArea, TextField, Button } from '@hs2190.an/iris-react';
...
export default function TextAreaPage() {
 ...
 />
      ...
      <Section title="Code" desc="Playground에서 고른 설정이 그대로 반영됩니다.">
        <CodeSpec name="TextArea" code={`<TextArea label="자기소개" maxLength={200} showCount${st === 'error' ? ' error="10자 이상 입력해 주세요"' : ''}${st === 'disabled' ? ' disabled' : ''} />`} />
      </Section>
      <Section title="Props">
        <Props rows={[
