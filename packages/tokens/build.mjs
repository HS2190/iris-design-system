// @iris/tokens build — Figma export(src/*.json) → dist/iris.css · tokens.json · tokens.js
...
let css = `/* @iris/tokens — generated ${new Date().toISOString().slice(0,10)} from Figma k6EMzf6Q9nM7J1gkAt4ZYo. 수정 금지: Figma → build로만 변경 */\n`;
